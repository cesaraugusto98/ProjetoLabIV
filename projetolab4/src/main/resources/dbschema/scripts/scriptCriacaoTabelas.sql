...
CREATE TABLE if not exists VEN_VENDA(
...
CREATE TABLE if not exists MET_MOVIMENTO_ENTRADA(
...
CREATE TABLE if not exists MES_MOVIMENTO_SAIDA(
...
CREATE TABLE if not exists ITV_ITEM_VENDA(
