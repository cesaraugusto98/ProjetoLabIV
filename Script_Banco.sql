...
CREATE TABLE EST_ESTOQUE(
	EST_ESTOQUE INT NOT NULL AUTO_INCREMENT,
    EST_QTD INT NOT NULL,
	PRIMARY KEY(EST_ESTOQUE)
);
...
CREATE TABLE CRN_CARRINHO(
	CRN_ID INT AUTO_INCREMENT,
...
CREATE TABLE VEN_VENDA(
    ...
    FOREIGN KEY(CRN_ID) REFERENCES CRN_CARRINHO(CRN_ID),
